                ...
                if($(this).data('text') != undefined) {
					...
					if($(this).data('icon') != undefined) {
					 ...
					 if($(this).data('type') != undefined) {
						...
						$(this).append('<span class="circle-text">' + icon + text + '<small>%</small>' +  '</span>');
						$(this).find('.circle-text').css({'line-height': dimension + 'px', 'font-size' : size + 'px' ,'color' : fgcolor});
						$(this).find('.circle-text').find('small').css({'font-size' : '58%' })
					}
