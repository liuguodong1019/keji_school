...
<div class="form-group d02">
	<label for="" class="col-sm-2 control-label">文档</label>
	<div class="col-sm-10 item_novideo" style="display:block;">
		<ul class="nav nav-pills" role="tablist">
			<li class="active">
				<a href="#aa" class="btn btn-default fff" data-toggle="tab">上传文档</a>
			</li>
			<li>
				<a href="#ss" class="btn btn-default" onclick="upliad_file_list();" data-toggle="tab">从课程文件中选择</a>
			</li>
			<li class="link_v_b">
				<a href="#dd" class="btn btn-default" data-toggle="tab">导入网络文档</a>
			</li>
		</ul>
			...
			<div role="tabpanel" class="tab-pane fade active in" id="aa">
				<div class="file-chooseer-frame">
					...
					<ul id="url">
					 ...
					 <span class="help-block text-danger" style="display:none;">请选择文档</span>
					<!-- <div class="alert alert-info in active" role="alert"> -->
						<ul class="type_zhichi">
							<li><i></i>支持word、pdf、excel格式的视频文件上传，文件大小不能超过1G 。</li>
						</ul>
					<!-- </div> -->
				</div>
			</div>
