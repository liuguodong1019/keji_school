<div class="video-content">
	...
	<video width="100%" height="100%" controls="controls" id="video">
		<source src="<?php echo site_url("public/home/file/{$lesson[1]['hashname']}");?>" type="audio/mp3"></source>
		您的浏览器不支持video标签
	</video>
	<!-- <video width="100%" height="100%" controls="controls" id="video" src="<?php //echo site_url("public/home/file/{$lesson[1]['hashname']}");?>">
		您的浏览器不支持video标签
	</video> -->
	<?php
	}
